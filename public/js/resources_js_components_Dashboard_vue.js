...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "Dashboard",
  mounted: function mounted() {//this.me()
    //this.increment()
    //this.getBrand()
    //this.store()
  },
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                device = localStorage.getItem('v_device');
                ...
                _context.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get('/api/customer/' + device).then(function (response) {
                  console.log(response);
                });
    ...
    add: function add() {
      axios__WEBPACK_IMPORTED_MODULE_1___default().post('/api/cart-item/add', {
        customer_id: 1,
        product_id: 3
      }).then(function (response) {
        console.log(response);
