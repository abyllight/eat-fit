"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_UpdatePassword_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    validate: function validate() {
      ...
      axios.patch('/api/couriers/' + this.$route.params.id, {
        ...
        _this.$router.push('/couriers');
      })["catch"](function (error) {
        _this.$store.commit('SET_ALERT', {
          'isVisible': true,
          'msg': error.message,
          'color': 'error',
          'type': 'error'
